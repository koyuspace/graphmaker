...
export const strings = new LocalizedStrings({
  en: {
    ...
    abort: 'Abort',
    next: 'Next',
    edgeValueDialog: 'Choose a shape',
    edgeColorDialog: 'Enter edge color',
    edgeLabelDialog: 'Enter edge label',
    save: 'Save',
    open: 'Open',
    print: 'Print',
    addNode: 'Add node',
  ...
  de: {
    ...
    abort: 'Abbrechen',
    next: 'Weiter',
    edgeValueDialog: 'Wähle eine Form',
    edgeColorDialog: 'Wähle eine Farbe für die Linie',
    edgeLabelDialog: 'Benenne die Linie',
    save: 'Speichern',
    open: 'Öffnen',
    print: 'Drucken',
